...
namespace ThreeL.Blob.Migrations.Migrations
{
    ...
    [Migration("20240204070307_AddFileTrackPath")]
    partial class AddFileTrackPath
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ThreeL.Blob.Domain.Aggregate.User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreateBy = 0L,
                            CreateTime = new DateTime(2024, 2, 4, 15, 3, 7, 621, DateTimeKind.Local).AddTicks(1763),
                            DaliyUploadMaxSizeLimit = 0L,
                            IsDeleted = false,
                            Location = "D:\\ThreeL_blob\\admin",
                            Password = "87NLwc3m69ImImDt4PMbig==.cxgVDtWaQO7Z0p/2iAuPXQ6C1jM5Udt/qtW9m0ARpCY=",
                            Role = 1,
                            TodayUploadMaxSize = 0L,
                            UploadMaxSizeLimit = 0L,
                            UserName = "admin"
                        });
                });
