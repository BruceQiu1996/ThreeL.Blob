...
namespace ThreeL.Blob.Application.Contract.Services
{
    public interface IFileService
    {
        ...
        Task<ServiceResult<FileObjDto>> GetRootItemAsync(long userId);
        ...
        Task<ServiceResult> CompressFileObjectsAsync(long sender, CompressFileObjectsDto compressFileObjectsDto);
        Task<ServiceResult<(int, IEnumerable<FileObjectShareRecordDto>)>> GetShareFileRecordsAsyncByPage(long userId, string keyWord, int page);
    }
}
