namespace ThreeL.Blob.Shared.Domain
{
    ...
    {
        public const string LoginSuccess = "S-C_LoginSuccess";
        public const string NewAddFriendApply = "S-C_NewAddFriendApply";
        public const string ReceiveTextMessage = "S-C_ReceiveTextMessage";
        public const string ReceiveFileMessage = "S-C_ReceiveFileMessage";
        public const string ReceiveFolderMessage = "S-C_ReceiveFolderMessage";
        public const string ReceiveWithdrawMessage = "S-C_ReceiveWithdrawMessage";
